...
playwright install-deps chromium || echo "⚠️  Failed to install Chromium system dependencies"
playwright install chromium || echo "⚠️  Playwright Chromium install failed - screenshots won't work"
