...
def get_favorite_teams_from_config():
    ...
    try:
        ...
        config_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'js', 'config.js')
...
def get_screensaver_data(league):
    ...
    try:
        ...
        article_data = screensaver_service.fetch_article_for_favorites(favorite_teams, league.lower())
